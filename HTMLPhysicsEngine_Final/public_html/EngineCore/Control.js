...
function control(event)
{
    ...
    if (keycode === 85) {
        ...
        gEngine.Core.mAllObject[gObjectNum].mAngluarVelocity -= 0.1;
    }
    if (keycode === 79) {
        //O
    ...
    if (keycode === 90) {
        //Z
        var mass = 1 / gEngine.Core.mAllObject[gObjectNum].mMass;
        mass -= 1;
        gEngine.Core.mAllObject[gObjectNum].mMass = 1 / mass;
    }
    if (keycode === 88) {
        //X
        var mass = 1 / gEngine.Core.mAllObject[gObjectNum].mMass;
    ...
    if (keycode === 72) {
        ...
        for (i = 0; i < gEngine.Core.mAllObject.length; i++) {
            if (gEngine.Core.mAllObject[i].mMass !== 0)
