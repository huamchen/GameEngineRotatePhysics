        ...
        if (dot < 0) {
            ...
            else
            {
                ...
                if (bestDistance < otherCir.mRadius) {
                    var radiusVec=this.faceNormal[nearestEdge].scale(otherCir.mRadius);
                    collisionInfo.setInfo(otherCir.mRadius - bestDistance, this.faceNormal[nearestEdge], circ2Pos.subtract(radiusVec));
                }
                else {
                    return false;
                }
